  ...
  <header class="bg-gray-800 text-white p-4 sm:p-6 lg:p-8 relative z-20">
    <div class="container mx-auto flex items-center justify-between relative">
      ...
      <nav class="flex space-x-4 sm:space-x-6 items-center ml-auto">
        ...
        <a :href="getLoginUrl()" class="hover:text-gray-300 transition-colors duration-300 text-base sm:text-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 rounded px-2 py-1">
          {{ $t('login') }}
        </a>
      </nav>
    </div>
...
export default {
  ...
  methods: {
    getLoginUrl() {
      // Return absolute URL to force proper navigation
