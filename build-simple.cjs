    ...
    <script>
        ...
        createApp({
            ...
            methods: {
                async fetchNews() {
                    try {
                            ...
                            this.newsItems = [
                                {
                                    ...
                                    description: 'Your TV-compatible news application is now running successfully with all original features restored.',
                                ...
                                },
                                {
                                    ...
                                    description: 'This application is optimized for TV browsers and remote control navigation with Vue.js components.',
                                    date: new Date().toLocaleDateString(),
                                    category: 'Technology',
                                    image_url: this.fallbackImage
                                },
                                {
                                    ...
                                    description: 'Support for English, Hebrew, and Arabic languages with RTL text direction and i18n integration.',
                                    date: new Date().toLocaleDateString(),
                                    category: 'Features',
                                    image_url: this.fallbackImage
                                },
                                {
                                    id: 4,
                                    title: 'Auto-Slide News Slider',
                                    description: 'Automatic sliding news carousel with pause/resume functionality and customizable timing.',
                                    date: new Date().toLocaleDateString(),
                                    category: 'Features',
                                    image_url: this.fallbackImage
                                },
                                {
                                    id: 5,
                                    title: 'Network Recovery System',
                                    description: 'Automatic network failure detection and recovery with IP change handling.',
                                    date: new Date().toLocaleDateString(),
                                    category: 'Technology',
                                    image_url: this.fallbackImage
                                }
                        ...
                        // Still show sample data even if API fails
                        this.newsItems = [
                            {
                                id: 1,
                                title: 'WeARE News - Original System Restored',
                                description: 'Your sophisticated Vue.js news application with all original features is now working properly.',
                                date: new Date().toLocaleDateString(),
                                category: 'System',
                                image_url: this.fallbackImage
                            }
            ...
            async mounted() {
                ...
                // Set up refresh interval like original app
                setInterval(() => {
                    this.fetchNews();
                }, 5 * 60 * 1000); // 5 minutes
            },
